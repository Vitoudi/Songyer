...
export default function CurrentPlayerBord({ room, setMobileMenuOpen }) {
  ...
  if (room.songCode) {
    return <ManagerBord setMobileMenuOpen={setMobileMenuOpen} room={room} />;
  }
  ...
  return (
    <div className={styles["current-player-bord-container"]}>
      ...
      <input
        placeholder="Ex: hey jude - the beatles"
        className="input-1"
        value={searchTerm}
        onChange={(e) => {
